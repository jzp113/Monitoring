...
class StdOutListener(StreamListener):
    ...
    def on_data(self, data):
        ...
        c.execute("replace INTO tweets (screen_name,tweet_at,born,urls,symbols,description, username, text, followers, friends, source, location, tweet_id, statuses_count, time_zone, utc_offset, user_id, verified, in_reply_to_screen_name, in_reply_to_status_id, in_reply_to_user_id,user_mentions, logged) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",([screen_name,tweet_at,born,urls,symbols,description, username, text, followers, friends, source, location, tweet_id, statuses_count, time_zone, utc_offset, user_id, verified, in_reply_to_screen_name, in_reply_to_status_id, in_reply_to_user_id,user_mentions,datetime.datetime.now()]))
        conn.commit()        
